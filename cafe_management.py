...
class cafe_management():
        ...
        def Total_Bill(self):
                ...
                self.Total_Bill = self.pepsi_cost + self.fries_cost + self.pizza_cost +  self.burger_cost + self.cake_cost + self.sandwich_cost + self.coffee_cost + self.tea_cost
        ...
        def Clear(self):
                ...
                self.sandwich_item.delete(0,"end")
        ...
        def __init__(self):
                ...
                self.sandwich = Label(self.frame1,text="Sandwich",font=('verdana',10,'bold'),bg="white")
                self.sandwich.place(x=3,y=40)
                self.sandwich_item = Entry(self.frame1,width=7,borderwidth=4,relief=SUNKEN,bg="#248aa2")
                self.sandwich_item.place(y=40,x=85)
